    ...
    e.cleanData = function (t) {
        ...
        _on: function (i, s, n) {
            ...
            "boolean" != typeof i && (n = s, s = i, i = !1), n ? (s = a = e(s), this.bindings = this.bindings.add(s)) : (n = s, s = this.element, a = this.widget()), e.each(n, function (n, o) {
                ...
                var l = n.match(/^(\w+)\s*(.*)$/), u = l[1] + r.eventNamespace,
                    c = l[2];
...
(function (e) {
    e.widget("ui.draggable", e.ui.mouse, {
        ...
        start: function (t, i) {
            var s = e(this).data("ui-draggable"), n = s.options,
        ...
        start: function () {
            ...
            var s, n, a, o, r, h, l, u, c, d, p = e(this).data("ui-draggable"),
                f = p.options, m = f.snapTolerance, g = i.offset.left,
                v = g + p.helperProportions.width, b = i.offset.top,
...
(function (e) {
    ...
    e.widget("ui.resizable", e.ui.mouse, {
        ...
        _mouseStart: function (i) {
            var s, n, a, o = this.options, r = this.element.position(),
                h = this.element;
        ...
        _mouseDrag: function (t) {
            var i, s = this.helper, n = {}, a = this.originalMousePosition,
                o = this.axis, r = this.position.top, h = this.position.left,
                l = this.size.width, u = this.size.height,
                c = t.pageX - a.left || 0, d = t.pageY - a.top || 0,
                p = this._change[o];
        ...
        _respectSize: function (e) {
            var t = this._vBoundaries, s = this.axis,
                ...
                l = this.position.top + this.size.height, u = /sw|nw|w/.test(s),
                c = /nw|ne|n/.test(s);
        ...
        stop: function (t) {
            var i = e(this).data("ui-resizable"), s = i.options,
        ...
        start: function () {
            var i, s, n, a, o, r, h, l = e(this).data("ui-resizable"),
                u = l.options, c = l.element, d = u.containment,
            ...
            var i, s, n, a, o = e(this).data("ui-resizable"), r = o.options,
                h = o.containerOffset, l = o.position,
                u = o._aspectRatio || t.shiftKey, c = {top: 0, left: 0},
            ...
            var t = e(this).data("ui-resizable"), i = t.options,
                s = t.containerOffset, n = t.containerPosition,
                a = t.containerElement, o = e(t.helper), r = o.offset(),
        ...
        start: function () {
            ...
            var s = e(this).data("ui-resizable"), n = s.options,
                a = s.originalSize, o = s.originalPosition, r = {
                    ...
                    e(t).each(function () {
                        var t = e(this),
                            n = e(this).data("ui-resizable-alsoresize"), a = {},
        ...
        resize: function () {
            var t = e(this).data("ui-resizable"), i = t.options, s = t.size,
                n = t.originalSize, a = t.originalPosition, o = t.axis,
                r = "number" == typeof i.grid ? [i.grid, i.grid] : i.grid,
                h = r[0] || 1, l = r[1] || 1,
                u = Math.round((s.width - n.width) / h) * h,
                c = Math.round((s.height - n.height) / l) * l, d = n.width + u,
                p = n.height + c, f = i.maxWidth && d > i.maxWidth,
