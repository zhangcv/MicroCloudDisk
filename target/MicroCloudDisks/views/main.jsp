    ...
    <div class="main-head-right">
        <div class="main-head-right-user">
            ...
            <div class="main-head-right-user-right">
                <a href=""
                   style="margin: 0px 10px;line-height: 68px;font-family:'宋体';font-size: 16px;text-decoration: none;">
                    专用下载器下载
                </a>
            </div>
        </div>
                        ...
                        <tr>
                            ...
                            <c:choose>
                                <c:when test="${fl.filetype=='folder'}">
                                    ...
                                    <td onclick="detailFilesList('${fl.folderid}')">
                                        <img src=${fl.icon}> ${fl.foldername}
                                    </td>
                                </c:when>
                                <c:otherwise>
                            ...
                            <td>
                                ...
                                <c:choose>
                                    <c:when test="${fl.filetype!='folder'}">
                                        <a href="download?filename=${fl.foldername}&fileid=${fl.folderid}">
                                    ...
                                    <c:otherwise>
                                        <button onclick="detailFilesList('${fl.folderid}')"
                                                class="btn btn-sm btn-default">
                                            进 入
                                        </button>
                                    </c:otherwise>
...
<script>
    ...
    function detailFilesList(fileid) {
        // alert(fileid);
        document.getElementById('fileid').value = fileid;
        // document.getElementById('updateFilepathID').value = filepath;
