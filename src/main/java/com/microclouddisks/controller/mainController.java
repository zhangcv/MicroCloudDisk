...
//        String usermail = request.getParameter("usermail");
    ...
    public String deleteOne(HttpServletRequest request) throws IOException {
    ...
    public String SearchFile(HttpServletRequest request, HttpSession session, Model model) {
        ...
        System.out.println("Search controller " + "zhangcv2017@163.com" + ", " + filename);
        List<folder> filelists = mainservice.likeQueryByFileName(filename, "zhangcv2017@163.com");
